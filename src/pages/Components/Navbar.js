...
function Navbar() {
  ...
  return (
    <div>
          <nav className="relative px-4 py-4 flex justify-between items-center bg-gray-400">
            <a className="text-3xl font-bold leading-none" href="#">
              ...
              <img src="/download-removebg-preview.png" alt="" style={{ height: '100px' }}/>
            </a>
            ...
            <ul className="hidden absolute top-1/2 left-1/2 transform -translate-y-1/2 -translate-x-1/2 lg:flex lg:mx-auto lg:flex lg:items-center lg:w-auto lg:space-x-6">
              <li>
                <Link
                  id="p1"
                  className="text-base text-white hover:text-yellow-500 font-bold"
                  href="/"
                >
                  Home
                </Link>
