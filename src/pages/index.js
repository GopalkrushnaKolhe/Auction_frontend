...
>
  ...
  <div
    class="absolute inset-x-0 bottom-0 z-[2] mx-[15%] mb-2 flex list-none justify-center p-0"
  ...
  <div
    ...
    <div
      ...
      <img
        ...
        alt="Motorbike Smoke" />
      <div
        class="absolute inset-x-[15%] bottom-2 hidden py-5 text-center text-black md:block">
  ...
  <div
    ...
    <button
      ...
      data-te-slide-to="0"
      data-te-carousel-active
      class="mx-[3px] box-content h-[2px] w-[20px] flex-initial cursor-pointer border-0 border-y-[8px] border-solid border-transparent bg-black bg-clip-padding p-0 -indent-[999px] opacity-50 transition-opacity duration-[600ms] ease-[cubic-bezier(0.25,0.1,0.25,1.0)] motion-reduce:transition-none"
      aria-current="true"
      aria-label="Slide 1"></button>
    <button
      data-te-target="#carouselDarkVariant"
