...
export default function Contact() {
      ...
      <nav className="relative px-4 py-4 flex justify-between items-center bg-white">
        ...
        <ul className="hidden absolute top-1/2 left-1/2 transform -translate-y-1/2 -translate-x-1/2 lg:flex lg:mx-auto lg:flex lg:items-center lg:w-auto lg:space-x-6">
          <li>
            <Link
              id="p1"
              className="text-sm text-blue-600 hover:text-gray-500 font-bold"
              href="/"
            >
              Home
            </Link>
      ...
      <div className="navbar-menu relative z-50 hidden">
        ...
        <nav className="fixed top-0 left-0 bottom-0 flex flex-col w-5/6 max-w-sm py-6 px-6 bg-white border-r overflow-y-auto">
          ...
          <div className="mt-auto">
            <div className="pt-6">
              {/* <a className="block px-4 py-3 mb-3 leading-loose text-xs text-center font-semibold leading-none bg-gray-50 hover:bg-gray-100 rounded-xl" href="#">Login</a> */}
  ...
  <div className="container px-5 py-24 mx-auto flex sm:flex-nowrap flex-wrap">
    <div className="lg:w-2/3 md:w-1/2 bg-gray-300 rounded-lg overflow-hidden sm:mr-10 p-10 flex items-end justify-start relative">
      {/* <iframe width="100%" height="100%" className="absolute inset-0" frameborder="0" title="map" marginheight="0" marginwidth="0" scrolling="no" src="https://maps.google.com/maps?q=katraj+pune+india&amp;ie=UTF8&amp;iwloc=&amp;output=embed"></iframe> */}
      <iframe
      width="100%"
      height="100%"
      ...
      marginWidth="0"
      scrolling="no"
      src="https://maps.google.com/maps?q=PICT+College+Katraj+Pune+India&amp;ie=UTF8&amp;iwloc=&amp;output=embed"
    ...
    <div className="lg:w-1/3 md:w-1/2 bg-white flex flex-col md:ml-auto w-full md:py-8 mt-8 md:mt-0">
      ...
      <div classNameNamwe="relative mb-4">
